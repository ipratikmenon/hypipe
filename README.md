...
| `fx_commodities/` | Planned | Orderflow + liquidity-heatmap prediction engine for currency crosses (EURUSD/GBPUSD/USDJPY), bullion (gold/silver), and commodities (crude/natgas/copper) |
